...
- PROXIMITY (2026-09-03): every WebAudio sound leaves through `SND.prox`, set each frame by `proxStep`
  to sqrt(2 m / distance to the object), floor 0.25: a third at the hall end, ~0.6 on the orbit, full
  at the shell. Held at 1 through the crash, kaleidoscope, tour and rest, and once the object has sunk.
