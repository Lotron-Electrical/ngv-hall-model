...
for spec in sys.argv[2:]:
    ...
    GR = {'north': [[8.310,9.086,2.626,2.974],[30.178,31.094,2.694,3.034],[33.854,34.782,2.718,3.034],[37.322,38.270,2.670,2.998],[41.022,41.902,2.630,2.958],[44.666,45.626,2.642,3.010]],
          'south': [[4.682,5.610,2.954,3.262],[9.346,10.242,2.994,3.266],[42.714,43.670,2.822,3.114]]}[side]
    DR = {'north': [[45.970,47.786,2.970],[23.10,29.40,2.3]], 'south': [[37.962,39.662,2.906],[45.698,48.218,2.522]]}[side]
    for a, b, y0, y1 in GR:
        c4 = [pt(a, dw, y0), pt(b, dw, y0), pt(b, dw, y1), pt(a, dw, y1)]
        for j in range(4): line(c4[j], c4[(j + 1) % 4], (0, 255, 0), 2)
    for a, b, y1 in DR:
        c4 = [pt(a, dw, 0), pt(b, dw, 0), pt(b, dw, y1), pt(a, dw, y1)]
