...
await ev(`(()=>{const g=window.game,L=g.lift,P=g.player;L.anim=null;L.aboard=true;P.onLift=true;L.gate.rotation.y=Math.PI/2;L.aboard=false;P.onLift=false;const o=L.group.localToWorld(new P.pos.constructor(-3.2,0,1.2));P.pos.set(o.x,g.world.floorY,o.z);P.eye=1.68;P.yaw=L.yaw-Math.PI/2+0.35;P.pitch=0.05;})()`); await sleep(300); await shot('gateopen');
